          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-slate-900">support@myexampadi.com</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="size-12 rounded-full bg-primary/10 flex items-center justify-center text-primary">
              ...
              <div>
                ...
                <p className="font-semibold text-slate-900">+234 123 456 7890</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="size-12 rounded-full bg-primary/10 flex items-center justify-center text-primary">
              ...
              <div>
                ...
                <p className="font-semibold text-slate-900">123 Innovation Drive, Lagos, Nigeria</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <form className="space-y-6">
            <div className="grid sm:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-primary/20 outline-none" placeholder="John Doe" />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Email Address</label>
                <input type="email" className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-primary/20 outline-none" placeholder="you@example.com" />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">Subject</label>
              <input type="text" className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-primary/20 outline-none" placeholder="How can we help?" />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">Message</label>
              <textarea rows={4} className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-primary/20 outline-none" placeholder="Type your message here..."></textarea>
            </div>
